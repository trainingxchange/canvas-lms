define('jst/publish_grades/SectionDropdownView', ["compiled/handlebars_helpers"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['publish_grades/SectionDropdownView'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data,depth1) {
  ...
  return templates['publish_grades/SectionDropdownView'];
});
