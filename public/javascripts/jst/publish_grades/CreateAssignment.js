define('jst/publish_grades/CreateAssignment', ["compiled/handlebars_helpers","i18n!publish_grades.create_assignment"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['publish_grades/CreateAssignment'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("publish_grades.create_assignment")
...
function program9(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    ...
    + escapeExpression((helper = helpers.datetimeFormatted || (depth0 && depth0.datetimeFormatted),options={hash:{},data:data},helper ? helper.call(depth0, (depth0 && depth0.dueAt), options) : helperMissing.call(depth0, "datetimeFormatted", (depth0 && depth0.dueAt), options)))
    + "\"\n          "
...
function program11(depth0,data) {
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("publish_grades.create_assignment")
  },data:data},helper ? helper.call(depth0, "more", "Go To %{objectType}", options) : helperMissing.call(depth0, "t", "more", "Go To %{objectType}", options));
  if(stack1 || stack1 === 0) { buffer += stack1; }
  ...
  return templates['publish_grades/CreateAssignment'];
});
