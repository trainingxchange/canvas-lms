define('jst/assignments/AssignmentSettings', ["compiled/handlebars_helpers","i18n!assignments.assignment_settings"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['assignments/AssignmentSettings'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, helper, options, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;


  buffer += "<div class=\"form-dialog-content\">\n  <div class=\"form-horizontal\">\n    <label class=\"checkbox\" id=\"weight-groups\" for=\"apply_assignment_group_weights\">\n      "
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("assignments.assignment_settings")
  ...
  return templates['assignments/AssignmentSettings'];
});
