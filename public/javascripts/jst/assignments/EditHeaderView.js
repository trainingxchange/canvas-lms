define('jst/assignments/EditHeaderView', ["compiled/handlebars_helpers","i18n!assignments.edit_header_view"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['assignments/EditHeaderView'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("assignments.edit_header_view")
...
function program3(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n  </div>\n  <div class=\"header-bar-right\">\n    <div class=\"admin-links\" role=\"application\">\n      <a role=\"button\" class=\"al-trigger btn\" href=\"#\">\n        <span class=\"screenreader-only\">";
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("assignments.edit_header_view")
  },data:data},helper ? helper.call(depth0, "manage_assignment", "Manage Assignment", options) : helperMissing.call(depth0, "t", "manage_assignment", "Manage Assignment", options));
  if(stack1 || stack1 === 0) { buffer += stack1; }
  ...
  return templates['assignments/EditHeaderView'];
});
