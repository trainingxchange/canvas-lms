define('jst/assignments/_assignmentListItemScore', ["compiled/handlebars_helpers","i18n!assignments.assignment_list_item_score"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['assignments/_assignmentListItemScore'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program4(depth0,data) {
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("assignments.assignment_list_item_score")
...
Handlebars.registerPartial('assignments/assignmentListItemScore', templates['assignments/_assignmentListItemScore']);

      
  return templates['assignments/_assignmentListItemScore'];
});
