define('jst/conversations/_courseOption', ["compiled/handlebars_helpers"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['conversations/_courseOption'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
Handlebars.registerPartial('conversations/courseOption', templates['conversations/_courseOption']);

      
  return templates['conversations/_courseOption'];
});
