(function() {
  define(['jquery', 'compiled/util/ScrollableListDataSource', 'compiled/util/shortcut', 'compiled/jquery/scrollIntoView', 'jquery.disableWhileLoading'], function($, ScrollableListDataSource, shortcut) {
    return (function() {
