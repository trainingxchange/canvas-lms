(function() {
  ...
  define(['i18n!recipient_input', 'jquery', 'underscore', 'compiled/util/contextList', 'compiled/widget/TokenInput', 'str/htmlEscape', 'jst/_avatar'], function(I18n, $, _, contextList, TokenInput, h, avatarTemplate) {
    var ContextSearch;
