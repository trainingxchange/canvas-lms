(function() {
  ...
  define(['jquery', 'underscore', 'compiled/views/PaginatedView', 'jquery.disableWhileLoading'], function($, _, PaginatedView) {
    ...
    return TokenSelectorList = (function(_super) {
      ...
      TokenSelectorList.prototype.initialize = function(options) {
        ...
        TokenSelectorList.__super__.initialize.apply(this, arguments);
