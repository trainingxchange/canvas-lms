  ...
  define(['underscore', 'i18n!editor', 'jquery', 'Backbone', 'compiled/fn/preventDefault', 'tinymce.editor_box'], function(_, I18n, $, Backbone, preventDefault) {
    ...
    EditorToggle = (function() {
      ...
      EditorToggle.prototype.createSwitchViews = function() {
        var $switchToHtmlLink, $switchToVisualLink, $switchViewsContainer,
          _this = this;
        ...
        $switchViewsContainer = $('<div/>', {
          style: "float: right"
        });
        $switchViewsContainer.append($switchToHtmlLink, $switchToVisualLink);
        $switchViewsContainer.find('a').click(preventDefault(function(e) {
          _this.textArea.editorBox('toggle');
