  ...
  define(['i18n!editor_accessibility', 'jquery'], function(I18n, $) {
    ...
    return EditorAccessiblity = (function() {
      ...
      EditorAccessiblity.prototype.accessiblize = function() {
        ...
        this._addTitles();
        this._addLabels();
        return this._highlightSelectedColor();
      };
      ...
      */
      ...
      EditorAccessiblity.prototype._highlightSelectedColor = function() {
        return $("body").on('click', '.mceColorSplitMenu td', function() {
          $(this).parentsUntil(".mceColorSplitMenu").find(".selectedColor").removeClass("selectedColor");
          return $(this).addClass("selectedColor");
        });
      };
      ...
      EditorAccessiblity.prototype._addTitles = function() {
        return this.$iframe.attr('title', I18n.t('titles.rte_help', 'Rich Text Area. Press ALT F10 for toolbar. Press ALT F8 for help.'));
      };
