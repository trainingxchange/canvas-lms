(function() {
  ...
  define(['jquery', 'underscore', 'Backbone', 'jst/quiz_reports/quizReportGenerator', 'compiled/models/QuizReport'], function($, _, _arg, quizReportGenerator, QuizReport) {
    ...
    return QuizReportGenerator = (function(_super) {
      ...
      QuizReportGenerator.prototype.initialize = function() {
        ...
        QuizReportGenerator.__super__.initialize.apply(this, arguments);
