(function() {
  ...
  define(['i18n!discussion_topics', 'Backbone', 'jquery', 'underscore', 'jst/DiscussionTopics/SummaryView', 'jst/_avatar'], function(I18n, Backbone, $, _, template) {
    ...
    return DiscussionTopicSummaryView = (function(_super) {
      ...
      DiscussionTopicSummaryView.prototype.initialize = function() {
        DiscussionTopicSummaryView.__super__.initialize.apply(this, arguments);
