(function() {
  define(['i18n!course_users', 'jquery', 'compiled/util/mixin', 'compiled/views/ValidatedMixin', 'jquery.instructure_forms', 'vendor/jquery.placeholder'], function(I18n, $, mixin, ValidatedMixin) {
