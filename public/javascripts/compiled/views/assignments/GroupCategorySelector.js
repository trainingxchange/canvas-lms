  ...
  define(['i18n!assignment', 'Backbone', 'underscore', 'jquery', 'jst/assignments/GroupCategorySelector', 'compiled/jquery/toggleAccessibly'], function(I18n, Backbone, _, $, template, toggleAccessibly) {
    ...
    return GroupCategorySelector = (function(_super) {
      ...
      GroupCategorySelector.prototype.toJSON = function() {
        var frozenAttributes, groupCategoryFrozen, groupCategoryLocked, _base;

        frozenAttributes = (typeof (_base = this.parentModel).frozenAttributes === "function" ? _base.frozenAttributes() : void 0) || [];
        groupCategoryFrozen = _.include(frozenAttributes, 'group_category_id');
        groupCategoryLocked = !this.parentModel.canGroup();
        return {
          ...
          gradeGroupStudentsIndividually: !this.hideGradeIndividually && this.parentModel.gradeGroupStudentsIndividually(),
