(function() {
  ...
  define(['i18n!roles', 'jquery', 'underscore', 'Backbone', 'jst/roles/manageRoles', 'compiled/views/roles/PermissionButtonView', 'compiled/views/roles/RoleHeaderView'], function(I18n, $, _, Backbone, template, PermissionButtonView, RoleHeaderView) {
    ...
    return ManageRolesView = (function(_super) {
      ...
      ManageRolesView.prototype.renderHeader = function() {
        ...
        this.$el.find('thead tr').html("<th>" + (I18n.t('permissions', 'Permissions')) + "</th>");
