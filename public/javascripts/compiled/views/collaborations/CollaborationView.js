(function() {
  ...
  define(['i18n!collaborations', 'jquery', 'underscore', 'Backbone', 'compiled/views/collaborations/CollaboratorPickerView', 'jst/collaborations/edit'], function(I18n, $, _arg, _arg1, CollaboratorPickerView, editForm) {
