  ...
  define(['i18n!editor', 'jquery', 'underscore', 'Backbone', 'compiled/views/tinymce/EquationToolbarView', 'jst/tinymce/EquationEditorView', 'jqueryui/dialog', 'mathquill'], function(I18n, $, _, Backbone, EquationToolbarView, template) {
    ...
    return EquationEditorView = (function(_super) {
      ...
      function EquationEditorView() {
        ...
        this.onClose = __bind(this.onClose, this);        _ref = EquationEditorView.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      EquationEditorView.prototype.onClose = function(e, ui) {
      ...
      EquationEditorView.prototype.toggleView = function(e) {
        var equation, view;
      ...
      EquationEditorView.prototype.setView = function(view, equation) {
        ...
        if (view === 'mathquill') {
          ...
          setTimeout(function() {
            return _this.$mathquillView.find('.mathquill-tab-bar li.mathquill-tab-selected a').focus();
          }, 200);
        } else if (view === 'mathjax') {
