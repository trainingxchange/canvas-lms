(function() {
  ...
  define(['underscore', 'jquery', 'jst/DiscussionTopics/pageNav', 'Backbone', 'compiled/views/DiscussionTopic/EntryCollectionView', 'compiled/jquery/scrollIntoView', 'underscore.flattenObjects'], function(_, $, pageNavTemplate, Backbone, EntryCollectionView) {
    ...
    return EntriesView = (function(_super) {
      ...
      EntriesView.prototype.initialize = function() {
        EntriesView.__super__.initialize.apply(this, arguments);
      ...
      EntriesView.prototype.handleKeyDown = function(e) {
        var entry, nodeName, reverse;
      ...
      EntriesView.prototype.traverse = function(el, reverse) {
        var backward, entry, id, json, list, next, pos;

        id = el.attr('id').replace('entry-', '');
        json = this.collection.toJSON();
        list = _.flattenObjects(json, 'replies', backward = !this.options.threaded);
        entry = _.find(list, function(x) {
          return x.id + '' === id;
        });
