(function() {
  ...
  define(['i18n!roster', 'jquery', 'Backbone', 'jst/courses/roster/index', 'compiled/views/ValidatedMixin', 'compiled/models/GroupCategory'], function(I18n, $, Backbone, template, ValidatedMixin, GroupCategory) {
    var RosterView, _ref;
    ...
    return RosterView = (function(_super) {
      ...
      RosterView.child('rosterTabsView', '[data-view=rosterTabs]');
      ...
      RosterView.prototype.course_id = function() {
        return ENV.context_asset_string.split('_')[1];
      };

      RosterView.prototype.canAddCategories = function() {
      ...
      RosterView.prototype.onFail = function(xhr) {
        var message, parsed, _ref1;

        if (xhr.statusText === 'abort') {
          return;
        }
        parsed = $.parseJSON(xhr.responseText);
        message = (parsed != null ? (_ref1 = parsed.errors) != null ? _ref1[0].message : void 0 : void 0) === "3 or more characters is required" ? I18n.t('greater_than_three', 'Please enter a search term with three or more characters') : I18n.t('unknown_error', 'Something went wrong with your search, please try again.');
