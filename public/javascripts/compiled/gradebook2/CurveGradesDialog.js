(function() {
  ...
  define(['i18n!gradebook2', 'jquery', 'jst/CurveGradesDialog', 'jquery.disableWhileLoading', 'jquery.instructure_forms', 'jqueryui/dialog', 'jquery.instructure_misc_plugins', 'compiled/jquery/fixDialogButtons', 'vendor/jquery.ba-tinypubsub'], function(I18n, $, curveGradesDialogTemplate) {
    ...
    return CurveGradesDialog = (function() {
      function CurveGradesDialog(_arg) {
        var context_url, locals,
          _this = this;

        this.assignment = _arg.assignment, this.students = _arg.students, context_url = _arg.context_url;
        ...
        this.$dialog.formSubmit({
          ...
          processData: function(data) {
            var cnt, curves, errorBox, idx, percent, pre;

            if (!_this.assignment.points_possible || _this.assignment.points_possible === "0") {
              errorBox = _this.$dialog.errorBox(I18n.t("errors.no_points_possible", "Cannot curve without points possible"));
              setTimeout((function() {
            ...
            for (idx in curves) {
              ...
              if (_this.assignment.grading_type === "gpa_scale") {
      ...
      CurveGradesDialog.prototype.curve = function() {
        var breakPercents, breakScores, breaks, cnt, color, currentBreak, data, finalScore, finalScores, final_users_for_score, idx, interval, maxCount, middleScore, pct, score, scoreCount, scores, should_assign_blanks, skipCount, student, sub, tally, user, users, users_for_score, width, _i, _len, _ref;
