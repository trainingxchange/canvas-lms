  ...
  define(['i18n!jobs', 'jquery', 'vendor/slickgrid', 'jquery.ajaxJSON', 'jqueryui/dialog'], function(I18n, $, Slick) {
    ...
    FlavorGrid = (function() {
      function FlavorGrid(options, type_name, grid_name) {
        ...
        this.restoreSelection = __bind(this.restoreSelection, this);
        this.saveSelection = __bind(this.saveSelection, this);
      ...
      FlavorGrid.prototype.saveSelection = function() {
        ...
        if (this.type_name === 'running') {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            row = _ref[_i];
            _results.push(this.oldSelected[this.data[row]['id']] = true);
          }
          return _results;
        }
      };

      FlavorGrid.prototype.restoreSelection = function() {
        var index, item, newSelected, _i, _len, _ref;
      ...
      FlavorGrid.prototype.refresh = function(cb) {
        ...
        return this.$element.queue(function() {
          return $.ajaxJSON(_this.options.url, "GET", {
            ...
            if (_this.sortData) {
              _this.sort(null, _this.sortData);
            } else {
    ...
    Workers = (function(_super) {
      ...
      function Workers(options) {
        this.runtime_formatter = __bind(this.runtime_formatter, this);        Workers.__super__.constructor.call(this, options, 'running', '#running-grid');
      }

      Workers.prototype.runtime_formatter = function(r, c, d) {
        var format, klass, runtime, runtime_string;
      ...
      Workers.prototype.init = function() {
        ...
        Workers.__super__.init.call(this);
        this.sort = function(event, data) {
          var field;
