  ...
  define(['Backbone', 'underscore', 'i18n!overrides', 'compiled/models/AssignmentOverride', 'compiled/models/Section'], function(_arg, _, I18n, AssignmentOverride, Section) {
    ...
    return DueDateList = (function() {
      function DueDateList(overrides, sections, assignment) {
        var includeDefaultDate, onlyVisibleToOverrides, override;
        ...
        includeDefaultDate = this.overrides.length < this.courseSectionsLength || this.courseSectionsLength === 0;
        onlyVisibleToOverrides = ENV.DIFFERENTIATED_ASSIGNMENTS_ENABLED && this.assignment.isOnlyVisibleToOverrides();
        if (includeDefaultDate && !onlyVisibleToOverrides) {
