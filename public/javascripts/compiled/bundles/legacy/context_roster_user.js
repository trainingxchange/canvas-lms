(function() {
  require(["jquery", "i18n!context.roster_user", "jquery.ajaxJSON", "jquery.instructure_misc_plugins", "jquery.loadingImg", "compiled/jquery.rails_flash_notifications", "link_enrollment"], function($, I18n) {
    return $(document).ready(function() {
      ...
      return $(".more_user_information_link").click(function(event) {
        event.preventDefault();
