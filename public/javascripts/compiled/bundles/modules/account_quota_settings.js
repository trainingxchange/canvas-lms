(function() {
  define(['jquery', 'underscore', 'Backbone', 'compiled/models/Account', 'compiled/views/accounts/settings/QuotasView', 'compiled/views/accounts/settings/ManualQuotasView'], function($, _, Backbone, Account, QuotasView, ManualQuotasView) {
