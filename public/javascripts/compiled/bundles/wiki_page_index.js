(function() {
  require(['jquery', 'i18n!pages', 'str/htmlEscape', 'compiled/collections/WikiPageCollection', 'compiled/views/wiki/WikiPageIndexView', 'vendor/jquery.cookie'], function($, I18n, htmlEscape, WikiPageCollection, WikiPageIndexView) {
