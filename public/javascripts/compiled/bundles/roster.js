(function() {
  require(['i18n!roster', 'Backbone', 'compiled/models/CreateUserList', 'compiled/models/Role', 'compiled/views/courses/roster/CreateUsersView', 'compiled/views/courses/roster/RoleSelectView', 'jst/courses/roster/rosterUsers', 'compiled/collections/RosterUserCollection', 'compiled/collections/RolesCollection', 'compiled/collections/SectionCollection', 'compiled/collections/GroupCategoryCollection', 'compiled/views/InputFilterView', 'compiled/views/PaginatedCollectionView', 'compiled/views/courses/roster/RosterUserView', 'compiled/views/courses/roster/RosterView', 'compiled/views/courses/roster/RosterTabsView', 'compiled/views/courses/roster/ResendInvitationsView', 'jquery'], function(I18n, _arg, CreateUserList, Role, CreateUsersView, RoleSelectView, rosterUsersTemplate, RosterUserCollection, RolesCollection, SectionCollection, GroupCategoryCollection, InputFilterView, PaginatedCollectionView, RosterUserView, RosterView, RosterTabsView, ResendInvitationsView, $) {
    var Model, attributes, course, createUsersView, fetchOptions, groupCategories, inputFilterView, resendInvitationsView, roleSelectView, rolesCollection, rosterTabsView, users, usersView, _ref;
    ...
    groupCategories = new (GroupCategoryCollection.extend({
      url: "/api/v1/courses/" + ((_ref = ENV.course) != null ? _ref.id : void 0) + "/group_categories"
    }));
    ...
    users.once('reset', function() {
      return users.on('reset', function() {
        var msg, numUsers;
