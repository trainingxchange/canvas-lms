(function() {
  require(['jquery', 'compiled/views/outcomes/ToolbarView', 'compiled/views/outcomes/SidebarView', 'compiled/views/outcomes/ContentView', 'compiled/views/outcomes/FindDialog', 'compiled/models/OutcomeGroup', 'jst/outcomes/browser', 'jst/outcomes/mainInstructions'], function($, ToolbarView, SidebarView, ContentView, FindDialog, OutcomeGroup, browserTemplate, instructionsTemplate) {
