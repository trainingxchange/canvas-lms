(function() {
  ...
  require(['i18n!outcomes', 'jquery', 'compiled/models/OutcomeGroup', 'compiled/views/outcomes/FindDialog', 'compiled/views/outcomes/FindDirectoryView', 'edit_rubric'], function(I18n, $, OutcomeGroup, FindDialog, FindDirectoryView, rubricEditing) {
    var EditRubricPage, initEditRubricPage;
    ...
    initEditRubricPage = function() {
      new EditRubricPage;
      return rubricEditing.init();
    };
    if ($.isReady) {
      return initEditRubricPage();
    } else {
