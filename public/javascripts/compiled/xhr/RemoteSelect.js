(function() {
  ...
  define(['jquery', 'underscore', 'compiled/class/cache', 'vendor/spin', 'jst/util/select/optgroups', 'jst/util/select/options'], function($, _, cache, Spinner, optGroupTpl, optsTpl) {
    var RemoteSelect;
