(function() {
  ...
  define(['i18n!calendar', 'jquery', 'compiled/util/semanticDateRange', 'compiled/calendar/CommonEvent', 'jquery.instructure_date_and_time', 'jquery.instructure_misc_helpers'], function(I18n, $, semanticDateRange, CommonEvent) {
    ...
    return CalendarEvent = (function(_super) {
      ...
      CalendarEvent.prototype.parseStartDate = function() {
        if (this.calendarEvent.start_at) {
          return $.fudgeDateForProfileTimezone(this.calendarEvent.start_at);
        } else {
          return null;
        }
      };
      ...
      CalendarEvent.prototype.parseEndDate = function() {
        if (this.calendarEvent.end_at) {
          return $.fudgeDateForProfileTimezone(this.calendarEvent.end_at);
        } else {
          return null;
        }
      };
      ...
      CalendarEvent.prototype.displayTimeString = function() {
        ...
        if (this.calendarEvent.all_day) {
          datetime = $.unfudgeDateForProfileTimezone(this.startDate());
          return "<time datetime='" + (datetime.toISOString()) + "'>" + ($.dateString(datetime)) + "</time>";
        } else {
          return semanticDateRange(this.calendarEvent.start_at, this.calendarEvent.end_at);
        }
      };

      CalendarEvent.prototype.readableType = function() {
        return this.readableTypes['event'];
      };

      CalendarEvent.prototype.saveDates = function(success, error) {
        return this.save({
          'calendar_event[start_at]': this.start ? $.unfudgeDateForProfileTimezone(this.start).toISOString() : '',
          'calendar_event[end_at]': this.end ? $.unfudgeDateForProfileTimezone(this.end).toISOString() : '',
