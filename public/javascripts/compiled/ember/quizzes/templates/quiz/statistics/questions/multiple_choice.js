define(['ember', 'compiled/ember/shared/helpers/common'], function(Ember) {
  Ember.TEMPLATES['quiz/statistics/questions/multiple_choice'] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("\n  </section>\n\n  <section class=\"discrimination-index-section\">\n    ");
  data.buffer.push(escapeExpression((helper = helpers.render || (depth0 && depth0.render),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0,depth0],types:["STRING","ID"],data:data},helper ? helper.call(depth0, "quiz/statistics/questions/multiple_choice/discrimination_index", "controller", options) : helperMissing.call(depth0, "render", "quiz/statistics/questions/multiple_choice/discrimination_index", "controller", options))));
  data.buffer.push("\n  </section>\n</div>\n\n");
