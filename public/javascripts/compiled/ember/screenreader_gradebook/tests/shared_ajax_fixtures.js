(function() {
  define(['ic-ajax', 'ember'], function(ajax, Ember) {
    var assignmentGroups, clone, concludedStudents, customColumns, default_grade_response, outcomeRollups, outcomeRollupsRaw, outcomes, outcomesRaw, sections, students, submissions;
    ...
    sections = [
      {
        id: '1',
        name: 'Vampires and Demons'
      }, {
        id: '2',
        name: 'Slayers and Scoobies'
      }
    ];
    customColumns = [
      {
