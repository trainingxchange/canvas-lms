define('jst/FolderTreeCollection', ["compiled/handlebars_helpers"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['FolderTreeCollection'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  return templates['FolderTreeCollection'];
});
