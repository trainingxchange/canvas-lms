define('jst/publish_grades/DueDateView', ["compiled/handlebars_helpers","i18n!publish_grades.due_date_view"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['publish_grades/DueDateView'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  buffer += "\n  <select class=\"section-list input-small\" name=\"course_section_id\" aria-labelledby=\"overrides_course_section\">\n  </select>\n\n  <div class=\"date_field_container\">\n    <input value=\""
    ...
    + escapeExpression((helper = helpers.datetimeFormatted || (depth0 && depth0.datetimeFormatted),options={hash:{},data:data},helper ? helper.call(depth0, (depth0 && depth0.unlock_at), options) : helperMissing.call(depth0, "datetimeFormatted", (depth0 && depth0.unlock_at), options)))
    + "\" type=\"text\"\n    class=\"date_field\" aria-labelledby=\"overrides_unlock_at\">\n  </div>\n\n  <div class=\"date_field_container to\">\n    <input name=\"lock_at\" value=\""
    + escapeExpression((helper = helpers.datetimeFormatted || (depth0 && depth0.datetimeFormatted),options={hash:{},data:data},helper ? helper.call(depth0, (depth0 && depth0.lock_at), options) : helperMissing.call(depth0, "datetimeFormatted", (depth0 && depth0.lock_at), options)))
    + "\" type=\"text\"\n    class=\"date_field\" aria-labelledby=\"overrides_lock_at\">\n  </div>\n\n  <div>\n    <a\n      href=\"#\"\n      class=\"remove-link\"\n      role=\"button\"\n      title='";
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("publish_grades.due_date_view")
  ...
  return templates['publish_grades/DueDateView'];
});
