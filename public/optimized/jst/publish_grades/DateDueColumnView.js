define('jst/publish_grades/DateDueColumnView', ["compiled/handlebars_helpers","i18n!publish_grades.date_due_column_view"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['publish_grades/DateDueColumnView'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("publish_grades.date_due_column_view")
...
function program10(depth0,data) {
  ...
  return templates['publish_grades/DateDueColumnView'];
});
