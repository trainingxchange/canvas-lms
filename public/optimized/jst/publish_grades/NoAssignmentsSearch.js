define('jst/publish_grades/NoAssignmentsSearch', ["compiled/handlebars_helpers","i18n!publish_grades.no_assignments_search"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['publish_grades/NoAssignmentsSearch'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("publish_grades.no_assignments_search")
  ...
  return templates['publish_grades/NoAssignmentsSearch'];
});
