define('jst/content_migrations/MoodleZip', ["compiled/handlebars_helpers","i18n!content_migrations.moodle_zip"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['content_migrations/MoodleZip'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("content_migrations.moodle_zip")
  ...
  return templates['content_migrations/MoodleZip'];
});
