define('jst/assignments/AssignmentGroupList', ["compiled/handlebars_helpers","i18n!assignments.assignment_group_list"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['assignments/AssignmentGroupList'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program4(depth0,data) {
  ...
  stack1 = (helper = helpers.t || (depth0 && depth0.t),options={hash:{
    'scope': ("assignments.assignment_group_list")
...
function program6(depth0,data) {
  ...
  return templates['assignments/AssignmentGroupList'];
});
