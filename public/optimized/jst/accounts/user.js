define('jst/accounts/user', ["compiled/handlebars_helpers"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['accounts/user'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return templates['accounts/user'];
});
